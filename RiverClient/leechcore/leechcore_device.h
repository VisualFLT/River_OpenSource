...
#define lcprintf(ctxLC, _Format, ...)        { Util_LogFileA(_Format, ##__VA_ARGS__); if(ctxLC->fPrintf[0]) { ctxLC->Config.pfn_printf_opt ? ctxLC->Config.pfn_printf_opt(_Format, ##__VA_ARGS__) : printf(_Format, ##__VA_ARGS__); } }
