...
extern const MIDL_SERVER_INFO LeechRpc_ServerInfo;
static const RPC_PROTSEQ_ENDPOINT __RpcProtseqEndpoint[] = 
    {
    {(unsigned char *) "ncacn_ip_tcp", (unsigned char *) "30326"}
    };


extern const RPC_DISPATCH_TABLE LeechRpc_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE LeechRpc___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x906B0DC2,0x1337,0x0666,{0x00,0x01,0x00,0x00,0x65,0x7A,0x63,0xDD}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&LeechRpc_v1_0_DispatchTable,
    1,
...
RPC_IF_HANDLE LeechRpc_v1_0_s_ifspec = (RPC_IF_HANDLE)& LeechRpc___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const RPC_DISPATCH_FUNCTION LeechRpc_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE LeechRpc_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)LeechRpc_table
    };
...
static const MIDL_STUB_DESC LeechRpc_StubDesc = 
    {
    (void *)& LeechRpc___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& LeechRpc_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION LeechRpc_NDR64__table[] =
    {
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE LeechRpc_NDR64__v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)LeechRpc_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO LeechRpc_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&LeechRpc_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE LeechRpc_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)LeechRpc_ReservedSubmitCommand
    };

static const MIDL_SERVER_INFO LeechRpc_ServerInfo = 
    {
    &LeechRpc_StubDesc,
    LeechRpc_ServerRoutineTable,
    leechrpc__MIDL_ProcFormatString.Format,
    (unsigned short *) LeechRpc_FormatStringOffsetTable,
    0,
